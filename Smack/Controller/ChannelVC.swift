...
class ChannelVC: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        NotificationCenter.default.addObserver(self, selector: #selector(ChannelVC.channelsLoaded(_:)), name: NOTIF_CHANELS_LOADED, object: nil)
...
extension ChannelVC: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        NotificationCenter.default.post(name: NOTIF_CHANELS_SELECTED, object: nil)
